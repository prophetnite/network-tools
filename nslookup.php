 ...
 * license: []
 * description:
 *   Performs server side nslookup lookup
 */

$title = "Online nslookup Lookup"; // website's title
...
if (isset($_GET['host'])) {
    ...
    echo "nslookup Complete with status: " . "OK?";
    // ---------------------------
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
     ...
     <div class="row">
        ...
        <form action="#"  method="get" id="testform" target="testresult">
            ...
            <button  type="submit" class="btn btn-primary" id="ping_submit" name="ping_submit" title="">Start nslookup Lookup »</button>
