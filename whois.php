<?php
/*
 * script:  whoistest.php
 * author:  Sebastian R. Usami <sebastianusami@gmail.com>
 * license: []
 * description:
 *   Performs server side whois lookup
 */

$title = "Online Whois Lookup"; // website's title
...
if (isset($_GET['host'])) {
    ...
    echo "Whois Complete with status: " . "OK?";
    // ---------------------------
 ...
 */
function test($host) {
     exec(sprintf('whois %s', escapeshellarg($host)), $res, $rval);
     return $res;
}
  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
     ...
     <div class="row">
        ...
        <h2>Web-Based Remote Whois Lookup Tool</h2>


        <form action="#"  method="get" id="testform" target="testresult">

            <legend>Remote Whois Lookup Service</legend>
            ...
            <button  type="submit" class="btn btn-primary" id="ping_submit" name="ping_submit" title="">Start Whois Lookup »</button>
