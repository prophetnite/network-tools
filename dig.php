 ...
 * license: []
 * description:
 *   Performs server side dig lookup
 */

$title = "Online dig Lookup"; // website's title
 ...
 */
function test($host) {
     exec(sprintf('dig %s', escapeshellarg($host)), $res, $rval);
     return $res;
}
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
     ...
     <div class="row">
        ...
        <form action="#"  method="get" id="testform" target="testresult">
            ...
            <button  type="submit" class="btn btn-primary" id="ping_submit" name="ping_submit" title="">Start dig Lookup »</button>
